    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
          <img src="./Images/register.png" alt="key" className='w-full rounded-2xl' />
        </div>
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          ...
          <input type="text"
            ...
            <div className=' flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              ...
              <Link to="/sign-in" className='text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-1'>SignIn</Link> 
              </p>
              <p>
          ...
          <div className=' flex items-center my-4 before:border-t before:flex-1  after:bg-gray-300 after:border-t after:flex-1  before:bg-gray-300'>
